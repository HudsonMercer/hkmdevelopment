          ...
          <Grid>
            ...
            <Grid.Row>
              <Grid.Column width={12}>
                <Container text>
                  <p>First implementation of a javascript library. Namely, JQuery. This implementation is primative and makes little to no use of third party tooling such as babel, webpack, or NodeJS.</p>
            ...
            <Grid.Row>
              <Grid.Column width={12}>
                <Container text>
                  ...
                  <p>
                    This version of the Tic Tac Toe demonstration takes a more modern "app" approach. It fully implements real-time multiplayer via Google's Firebase platform, state management with <a href="https://redux.js.org/introduction" target="_blank">Redux</a> and front end interaction with Facebook's React framework.
                  </p>
                  <p>
